...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r projector
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r projector -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-projector
cd docker-projector
...
| --- | --- | --- | --- |
| projector-server | 9002 | Web-GUI database management tool | Y |
| phpmyadmin | 9090 | Web-GUI database management tool | Y |
## Documentation

[Projector Administrator Guide](https://support.websoft9.com/docs/projector)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Projector Enterprise Support](https://apps.websoft9.com/projector) 
