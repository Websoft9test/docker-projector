...
安装本项目，确保符合如下的条件（[详细参考](https://github.com/projector/docker#recommended-system-requirements)）：
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| projector-server | 9002 | 浏览器访问 Projector | Y |
| phpmyadmin | 9090 | 数据库可视化管理工具 | Y |
## 文档

[Projector 管理员手册](https://support.websoft9.com/docs/projector)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Projector 企业级支持版](https://apps.websoft9.com/projector) 
